...
export const allRoutes = [
    ...
    new Route("/admin/manage-users", "Gestion des utilisateurs", "/pages/admin/manage-users.html"),
    new Route("/admin/manage-services", "Gestion des services", "/pages/admin/manage-services.html"),
    new Route("/admin/manage-habitats", "Gestion des habitats", "/pages/admin/manage-habitats.html"),
